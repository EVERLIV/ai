-- Support tickets (self-hosted). Идемпотентно. Применить на api.arendacity.com.
-- Полная копия: supabase/migrations/20260902_support_tickets.sql
...
BEGIN
  ...
  INSERT INTO public.support_tickets (
    ticket_number, user_id, account_type, category, status
  )
  VALUES (
    public.generate_ticket_number(), v_uid, v_account_type, v_category, 'open'
  )
  RETURNING * INTO v_ticket;

  INSERT INTO public.support_ticket_messages (ticket_id, author_type, author_id, body)
  VALUES (v_ticket.id, 'user', v_uid, v_message);
...
BEGIN
  ...
  INSERT INTO public.support_ticket_messages (ticket_id, author_type, author_id, body)
  VALUES (p_ticket_id, 'staff', v_uid, v_text)
  RETURNING * INTO v_msg;

  UPDATE public.support_tickets SET status = 'answered' WHERE id = p_ticket_id;
