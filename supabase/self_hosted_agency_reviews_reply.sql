-- =============================================================================
-- Agency review replies (agency members can answer)
-- Run after self_hosted_agency_reviews_auth.sql
-- =============================================================================
...
COMMENT ON COLUMN public.agency_reviews.reply_body IS
  'Ответ агентства/риелтора на отзыв; виден на публичной странице для published';
...
-- Members may UPDATE only via RPC above; keep SELECT as before.
-- Optional direct UPDATE for reply columns (PostgREST) — restricted by membership.
