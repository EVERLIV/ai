...
export function getListingPhoneFromExtras(extras?: Record<string, unknown> | null): string {
  if (!extras) return "";
...
export function getListingOwnerUserId(property: PropertyPhoneSource): string | null {
