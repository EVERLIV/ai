    ...
    <aside className="w-full space-y-5 min-w-0">
      ...
      >
        ...
        >
          ...
          >
            <h3 className="font-display text-lg font-bold leading-snug mb-0.5">
              БЦ «Кварта»
            </h3>
            <p className="text-background/70 text-xs mb-3">
              Иркутск, Центр · Офисы класса А
            </p>
            <div className="grid grid-cols-3 gap-2 text-center">
              {[
                ...
                >
                  ...
                  <div className="text-[9px] text-background/50 uppercase tracking-wide">
                    {s.label}
                  </div>
                </div>
              ))}
      ...
      >
        ...
        >
          ...
          <p className="text-[9px] text-background/35 text-center mt-2 uppercase tracking-widest">
            Реклама
          </p>
        </div>
      </div>
