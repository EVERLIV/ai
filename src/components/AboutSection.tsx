    ...
    <section ref={ref} id="about" className="py-20 bg-surface-warm">
      <div className={`container mx-auto px-4 lg:px-8 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Photo + quote */}
          <div className="lg:col-span-7 relative rounded-3xl overflow-hidden bg-foreground min-h-[440px]">
            <img
              src={managerPhoto}
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            <div className="bg-card rounded-3xl p-7 shadow-card flex-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                {stats.map((s) => {
                  const Icon = s.icon;
                  return (
                    <div key={s.label} className="rounded-2xl bg-surface-warm p-4">
            ...
            <div className="bg-foreground text-background rounded-3xl p-7 shadow-card">
