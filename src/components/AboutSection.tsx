...
import { Quote, Ban, Handshake, MapPinned, Unlock } from "lucide-react";
      ...
      <div className={`container mx-auto px-4 lg:px-8 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
        <div className="max-w-3xl mb-12">
          ...
          <h2 className="font-display text-4xl lg:text-5xl font-bold text-foreground leading-tight">
            АРЕНДА<span className="text-primary">СИТИ</span> — портал аренды и недвижимости региона
          </h2>
          <p className="mt-4 text-base text-muted-foreground leading-relaxed max-w-2xl">
            Площадку создало агентство недвижимости в Иркутске и области, чтобы жители могли
            находить объекты и сделки по аренде сами: бесплатно, без переплат на агрегаторах
            ...
            <div className="relative h-full flex flex-col justify-end p-8 lg:p-10 text-background">
              ...
              <div className="mt-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-background/70">Иркутск и область</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            <div className="bg-card p-7 shadow-card flex-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mb-5">
                Агентство работает на рынке региона с 2013 года. Портал — следующий шаг:
                вы сами смотрите объявления, связываетесь с менеджером или публикуете объект
                бесплатно. Жильё и коммерция в одном кабинете.
              </p>
                ...
                {reasons.map((r) => {
                  ...
                  return (
                    <div key={r.title} className="bg-surface-warm p-4">
                      ...
                      <div className="text-[11px] text-muted-foreground mt-1.5 leading-relaxed">{r.desc}</div>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="bg-foreground text-background p-7 shadow-card flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Link
                to="/about"
                className="inline-flex items-center justify-center h-10 px-4 bg-primary text-primary-foreground text-sm font-semibold hover:opacity-90 transition-opacity shrink-0"
              >
                О компании
              </Link>
            </div>
