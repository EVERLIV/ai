...
/**
 * Фиксированные UUID агентства ДАДАТУТ / Анастасии.
 * Должны совпадать с sql/seed_ДАДАТУТ_agency.sql
 */
export const ДАДАТУТ_AGENCY_ID =
  "a0000000-0000-4000-8000-000000000001" as const;
export const ДАДАТУТ_MANAGER_ID =
...
export const DEFAULT_AGENT = {
  ...
  agencyId: ДАДАТУТ_AGENCY_ID,
  managerId: ДАДАТУТ_MANAGER_ID,
  isVerified: true,
