...
export default function NewsPage() {
  ...
  const posts = useMemo(() => {
    ...
    return category === "Все" ? merged : merged.filter((p) => p.category === category);
  }, [data, category]);
      ...
      <main className="flex-1">
        <section className="bg-background border-b border-border py-12">
          <div className="container mx-auto px-3 lg:px-8">
            ...
            <p className="text-muted-foreground mb-6">Актуальные события рынка коммерческой недвижимости и аналитика по сегментам</p>
