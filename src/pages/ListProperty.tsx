        ...
        <div className="container mx-auto px-4 lg:px-8 py-10 lg:py-16">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <h1 className="font-display text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-4">
              Разместите объект — и получите арендатора <span className="text-primary">в течение 14 дней</span>
            </h1>
            <p className="text-base text-muted-foreground leading-relaxed">
              Выберите, как вам удобнее работать с нами: передать объект под полное управление АрендаСити
              или просто разместить его в каталоге и получать заявки.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
            {/* Left: mode chooser + benefits */}
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="bg-card rounded-3xl p-7 shadow-card">
                <h2 className="font-display text-2xl font-bold text-foreground mb-2">{data.title}</h2>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  const I = s.icon;
                  return (
                    <div key={s.label} className="bg-surface-warm rounded-2xl p-4">
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-24 bg-card rounded-3xl shadow-card p-6 lg:p-7 border border-gold/30">
                {sent ? (
                  ...
                  <>
                    <div className="mb-5">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Расскажите об объекте — мы перезвоним за 30 минут.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-2.5">
                      ...
                      <Textarea
                        name="message"
                        placeholder="Тип помещения, желаемая цена, особенности…"
                        rows={3}
