  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SeoHead
        ...
        description={
          isLand
            ? "Разместите участок на ДАДАТУТ бесплатно. Иркутск и область."
            : isResidential
              ? "Сдайте или продайте жильё на ДАДАТУТ бесплатно. Иркутск и область."
              : "Разместите коммерческий объект на ДАДАТУТ бесплатно. Иркутск и область."
        }
