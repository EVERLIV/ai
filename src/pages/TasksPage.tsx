...
export default function TasksPage() {
  ...
  const activeFilters = [filterAssignee, filterPriority !== "all"].filter(
    Boolean,
  ).length;
        ...
        <div className="bg-white border-b border-gray-200 px-3 md:px-5 py-2 md:py-3">
            ...
            {projects.map((p) => (
              <div key={p.id} className="relative group/proj shrink-0">
                <button
                  ...
                  style={
                    activeProjectId === p.id ? { backgroundColor: p.color } : {}
                  }
                >
                  <span
            ...
            {showNewProject ? (
              <div className="flex items-center gap-1 shrink-0">
                <input
                  ...
                  className="h-7 px-2 border border-gray-300 rounded-lg text-xs focus:outline-none w-28"
                />
                <button
                  onClick={handleCreateProject}
                  className="h-7 px-2 bg-gray-900 text-white text-xs rounded-lg"
                >
                  ОК
                </button>
                <button
          ...
          <div className="flex items-center justify-between md:hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className={`text-sm font-semibold ${mobileCol.headerColor}`}
                >
                  {mobileCol.label}
                </span>
              ...
              <button
                onClick={() =>
                  setMobileColIdx((i) => Math.min(COLUMNS.length - 1, i + 1))
                }
            ...
            <div className="flex items-center gap-1.5">
              ...
              >
                ...
                {activeFilters > 0 && (
                  <span className="w-3.5 h-3.5 bg-white text-gray-900 rounded-full text-[9px] font-bold flex items-center justify-center">
                    {activeFilters}
                  </span>
                )}
              </button>
          ...
          <div className="hidden md:flex items-center justify-end gap-2 mt-2">
            ...
            >
              ...
              {activeFilters > 0 && (
                <span className="w-4 h-4 bg-white text-gray-900 rounded-full text-[10px] font-bold flex items-center justify-center">
                  {activeFilters}
                </span>
              )}
            </button>
        ...
        {isLoading ? (
          ...
          >
            ...
            <div className="md:hidden flex-1 overflow-y-auto p-3">
              ...
              >
                <div
                  className={`min-h-[60vh] rounded-xl border-2 border-dashed p-3 flex flex-col gap-2 ${COL_BG[mobileCol.id]}`}
                >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2.5 px-1">
                      ...
                      <span
                        className={`text-sm font-semibold ${col.headerColor}`}
                      >
                        {col.label}
                      </span>
                    ...
                    >
                      <div
                        className={`flex-1 min-h-[200px] rounded-xl border-2 border-dashed p-2.5 flex flex-col gap-2 ${COL_BG[col.id]}`}
                      >
                        {colTasks.map((task) => (
                          <TaskCard key={task.id} task={task} />
                        ))}
