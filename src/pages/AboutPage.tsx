...
import {
  Quote, ShieldCheck, Users, Award,
  MapPin, Phone, Mail, ArrowRight,
  Building2, Clock, Star, BadgeCheck,
  Unlock, Ban, Handshake, MapPinned,
} from "lucide-react";
...
const timeline = [
  ...
  { year: "2016", text: "Работа в Ангарске и Шелехове. Рост портфеля коммерции." },
  { year: "2019", text: "Полный цикл: подбор, договоры, управление для собственников." },
  { year: "2022", text: "Направление рекламных конструкций и вывесок." },
  { year: "2025", text: "Запуск портала АрендаСити: бесплатный каталог для жителей региона." },
];
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="container mx-auto px-4 lg:px-8">
                ...
                <p className="text-background/80 text-base max-w-2xl leading-relaxed">
                  Портал аренды и недвижимости, созданный агентством в Иркутске и области —
                  чтобы жители региона находили объекты бесплатно, без переплат на агрегаторах
                  и без лишних комиссий.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              <div className="flex-1 min-w-0 space-y-12">
                ...
                <div className="space-y-4">
                  <h2 className="font-display text-2xl font-bold text-foreground">Кто мы</h2>
                  <div className="space-y-3 text-sm text-muted-foreground leading-relaxed max-w-3xl">
                    <p>
                      <span className="text-foreground font-medium">АрендаСити</span> — это онлайн-портал.
                      Его запустило агентство недвижимости, которое знает рынок Иркутска и области
                      изнутри: ставки, районы, документы, типичные риски сделок.
                    </p>
                    <p>
                      Мы сделали каталог открытым: смотрите объявления, сравнивайте варианты,
                      пишите менеджеру или публикуйте свой объект. Платить за «вход» на площадку
                      не нужно — ни арендатору, ни собственнику.
                    </p>
                    <p>
                      Если нужна помощь со сделкой, остаётесь с тем же агентством: показ,
                      договор, сопровождение. Если хотите разобраться сами — портал для этого и создан.
                    </p>
                  </div>
                </div>

                <div>
                  <h2 className="font-display text-2xl font-bold text-foreground mb-6">Почему так</h2>
                  ...
                  <div className="lg:w-1/2 flex flex-col justify-between p-8 lg:p-12 text-background">
                    <div className="mb-8">
                      ...
                      <blockquote className="font-display text-lg lg:text-xl leading-snug font-medium mb-5">
                        «Рынку региона нужен свой открытый каталог. Мы сделали портал, где объекты
                        доступны всем — а агентство рядом, если нужна помощь со сделкой.»
                      </blockquote>
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-px bg-primary" />
                        <div>
                          <div className="text-sm font-semibold">Команда АрендаСити</div>
                          <div className="text-xs text-background/50">Иркутск и область</div>
                        </div>
                      </div>
                    </div>

                    <div>
                      <h2 className="text-[10px] font-bold uppercase tracking-widest text-background/40 mb-5">История</h2>
                ...
                <div>
                  <h2 className="font-display text-2xl font-bold text-foreground mb-6">Что есть на портале</h2>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Вопросы по сотрудничеству, размещению объектов и работе с застройщиками —
                        на странице контактов или по телефону.
                      </p>
                      <a
                      ...
                      <div className="pt-1 flex flex-wrap gap-x-4 gap-y-2">
                        <Link to="/contacts" className="inline-flex items-center gap-1 text-sm text-primary hover:underline">
                          Все контакты <ArrowRight className="w-3.5 h-3.5" />
                        </Link>
                        <Link to="/list-property?mode=rent" className="inline-flex items-center gap-1 text-sm text-primary hover:underline">
